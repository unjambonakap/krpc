...
public class ReferenceFrame : Equatable<ReferenceFrame>
{
    ...
    [SuppressMessage ("Gendarme.Rules.Smells", "AvoidSwitchStatementsRule")]
    [KRPCProperty] public Vector3d Position {
        get {
            switch (type) {
            case ReferenceFrameType.CelestialBody:
            case ReferenceFrameType.CelestialBodyNonRotating:
    ...
    /// </summary>
    [KRPCProperty] public Vector3d Up {
    ...
    /// </summary>
    [KRPCProperty] public Vector3d Forward {
    ...
    /// </summary>
    public static Vector3d ToNorthPole (global::Vessel vessel)
    {
    ...
    /// </summary>
    [SuppressMessage ("Gendarme.Rules.Smells", "AvoidSwitchStatementsRule")]
    [KRPCProperty] public Vector3d Velocity {
        get {
            switch (type) {
            case ReferenceFrameType.CelestialBody:
            case ReferenceFrameType.CelestialBodyNonRotating:
    ...
    /// </summary>
    [SuppressMessage ("Gendarme.Rules.Smells", "AvoidSwitchStatementsRule")]
    [KRPCProperty] public Vector3d AngularVelocity {
        get {
            switch (type) {
            case ReferenceFrameType.CelestialBody:
    ...
    /// </summary>
    [KRPCMethod] public Vector3d AngularVelocityAt (Vector3d position)
    {
    ...
    /// </summary>
    [KRPCMethod] public Vector3d PositionFromWorldSpace (Vector3d worldPosition)
    {
    ...
    /// </summary>
    [KRPCMethod] public Vector3d PositionToWorldSpace (Vector3d position)
    {
    ...
    /// </summary>
    [KRPCMethod] public Vector3d DirectionToWorldSpace (Vector3d direction)
    {
    ...
    /// </summary>
    [KRPCMethod] public Vector3d VelocityFromWorldSpace (Vector3d worldPosition, Vector3d worldVelocity)
    {
    ...
    /// </summary>
    [KRPCMethod] public Vector3d VelocityToWorldSpace (Vector3d position, Vector3d velocity)
    {
    ...
    /// </summary>
    [KRPCMethod] public Vector3d AngularVelocityFromWorldSpace (Vector3d worldAngularVelocity)
    {
    ...
    /// </summary>
    [KRPCMethod] public Vector3d AngularVelocityToWorldSpace (Vector3d angularVelocity)
    {
